...
import 'package:test_flutter/getit/presentation/provider/getit_provider.dart';
...
class _GetItPageState extends State<GetItPage> {
  @override
  void initState() {
    // At your start-up you register all the objects you want to access later
    // like this:
...
class HomeGetIt extends StatelessWidget with GetItMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // You could tell your view to rebuild any time state changes with a simple
    // call to watchOnly:
    final state = watchOnly((GetItProvider getItProvider) => getItProvider.state);
      ...
      floatingActionButton: Column(
        ...
        children: <Widget>[
          FloatingActionButton(
            ...
            // After that you can access your GetItProvider class from anywhere
            // like this:
            onPressed: () => get<GetItProvider>().fetchData(),
          ),
        ],
      ),
    );
